...
const Home = () => {
  ...
  const handleConvert = async () => {
    ...
    if (code && language) {
      ...
      try {
        ...
        setLoading(false);
        setMessage(getErrorMessage(error, "Conversion failed."));
      }
    }
  };
  ...
  const handleDebug = async () => {
    ...
    if (code) {
      ...
      try {
        ...
        setLoading(false);
        setMessage(getErrorMessage(error, "Debug failed."));
      }
    }
  };
  ...
  const handleQualityCheck = async () => {
    ...
    if (code) {
      ...
      try {
        ...
        setLoading(false);
        setMessage(getErrorMessage(error, "Quality check failed."));
      }
    }
  };
  ...
  const handleGithubPaste = async (link) => {
    ...
    try {
      ...
      setLoading(false);
      setMessage(getErrorMessage(error, "GitHub import failed."));
    }
  };
